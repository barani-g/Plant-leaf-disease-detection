...
disease_dic = {
    ...
    'Magizham___healthy': """ <b>Crop</b>: Magizham <br/>Disease: No disease<br/>
       <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",
    
     'Magizham___Early_blight': """ <b>Crop</b>: Magizham <br/>Disease: Common Rust<br/>
         <br/> Cause of disease: 
        <br/><br/> The rust disease coats the underside of the leaf with orange pustules and causes leaves to turn yellow, then brown and rapidly defoliate.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Dust your plants with sulfur early in the season to prevent infection or to keep mild infections from spreading.
        <br/>2. Space your plants properly to encourage good air circulation.
        <br/>3. Avoid wetting the leaves when watering plants and Clean away all debris in between plants to prevent rust from spreading.""",
    ...
    'Pungamaram___healthy': """ <b>Crop</b>: Pungamaram <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",
    
    'Pungamaram___Common_rust_': """ <b>Crop</b>: Pungamaram <br/>Disease: disease detected<br/>
        <br/><br/> Your crop is not healthy!!!""",

    'Raspberry___healthy': """ <b>Crop</b>: Raspberry <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Sapota___healthy': """ <b>Crop</b>: Sapota <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",
    
    'Sapota___diseased': """ <b>Crop</b>: Sapota <br/>Disease: disease detected<br/>
        <br/><br/> Your crop is not healthy!!!""",
